const CustomerReferences = () => {
  const customers = [
    { name: "L'Oréal", logo: "/images/loreal-logo.png", scale: "scale-[2.2]" },
    { name: "DDA Consulting", logo: "/images/dda-consulting-logo.png", scale: "scale-[2.2]" },
    { name: "Fürsie", logo: "/images/fursie-logo.png", scale: "scale-90" },
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 lg:gap-20">
          {customers.map((customer, index) => (
            <div
              key={index}
              className="w-24 h-12 md:w-32 md:h-16 flex items-center justify-center opacity-40 hover:opacity-80 transition-opacity duration-300"
            >
              <img
                src={customer.logo}
                alt={customer.name}
